...
const ImageSection = ({ control, errors }: ImageSectionProps) => {
    ...
    return (
        <Card>
            <h4 className="mb-2">Imágenes del producto</h4>
            <p>
                Elegí una foto o arrastrá y soltá hasta 5 imágenes
                here.
            </p>
            <div className="mt-4">
                <FormItem
                                            ...
                                            <div className="max-w-full flex flex-col px-4 py-2 justify-center items-center min-h-[130px]">
                                                ...
                                                <p className="text-center mt-1 text-xs">
                                                    <span className="text-gray-800 dark:text-white">
                                                        Soltá tu imagen acá, o{' '}
                                                        {''}
                                                    </span>
                                                    <span className="text-primary">
                                                        hacé clic para buscar
                                                    </span>
                                                </p>
                                            </div>
                                        </Upload>
            ...
            <p>
                Formatos: .jpg, .jpeg, .png · tamaño ideal 1:1 · peso
