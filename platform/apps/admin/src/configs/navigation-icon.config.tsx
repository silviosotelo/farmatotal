...
const navigationIcon: NavigationIcons = {
    ...
    // Comercio (módulos de la tienda)
    cmVariants: <PiSwatchesDuotone />,
    cmInventory: <PiListChecksDuotone />,
    cmBranches: <PiMapTrifoldDuotone />,
    cmCoupons: <PiTagDuotone />,
    cmReviews: <PiListStarDuotone />,
    cmPages: <PiBrowsersDuotone />,
    cmSlides: <PiSquareSplitHorizontalDuotone />,
    cmMedia: <PiImagesDuotone />,
    cmStore: <PiStorefrontDuotone />,
    cmSettings: <PiGearDuotone />,
    cmModules: <PiPuzzlePieceDuotone />,
    cmIntegrations: <PiShareNetworkDuotone />,
    cmMailer: <PiEnvelopeDuotone />,
    cmPayments: <PiCurrencyCircleDollarDuotone />,
    cmShipping: <PiMapTrifoldDuotone />,
    cmReports: <PiChartLineUpDuotone />,
    cmTax: <PiReceiptDuotone />,
    cmUsers: <PiUsersDuotone />,
    cmAttributes: <PiStackPlusDuotone />,
}
