...
/**
 * /recuperar-contrasena en el patrón builder: el documento "recuperar-contrasena"
 * debe estar publicado y con bloques. Lo renderiza con ChaiRender (incluye el
 * PasswordRecoveryBlock, data-bound al API).
 */
