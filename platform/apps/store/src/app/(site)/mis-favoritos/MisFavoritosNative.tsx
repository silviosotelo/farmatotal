...
/**
 * Contenido nativo de "Mis Favoritos" (fallback cuando el documento del builder
 * no está publicado). Client-only: la lista vive en useWishlist, que combina el
 * cache de invitado (localStorage) con el respaldo por usuario vía los route
 * handlers /api/wishlist (proxy al backend del tenant). Mismo origen de datos
 * que el WishlistBlock del builder.
 */
export default function MisFavoritosNative() {
